...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt_layer',      type=int,   default=3)
    parser.add_argument('--gt_head',       type=int,   default=4)
    parser.add_argument('--gt_out_dim',    type=int,   default=256)
    ...
    parser.add_argument('--tr_layer',      type=int,   default=3)
    parser.add_argument('--tr_head',       type=int,   default=8)
    ...
    print(f'Model Config: gt_layer={args.gt_layer}, gt_head={args.gt_head}, '
          f'tr_layer={args.tr_layer}, tr_head={args.tr_head}, dropout={args.dropout}')
